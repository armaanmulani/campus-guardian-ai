...
export const MOCK_REPORTS: Report[] = [
  ...
  {
    id: "INC-104",
    description: "Water has pooled on the stairs and students are slipping.",
    category: "Water Leakage",
    severity: "High",
    location: "Block C Staircase (2nd Floor)",
    nodeId: "Node_27",
  ...
  {
    id: "INC-105",
    description: "The staircase floor is wet near Block C.",
    category: "Water Leakage",
    severity: "Medium",
    location: "Block C Staircase (2nd Floor)",
    nodeId: "Node_27",
  ...
  {
    id: "INC-106",
    description: "Please clean the water on the second-floor Block C stairs.",
    category: "Water Leakage",
    severity: "High",
    location: "Block C Staircase (2nd Floor)",
    nodeId: "Node_27",
  ...
  {
    id: "INC-107",
    description: "Lift B is still stuck and cannot be used.",
    category: "Broken Lift",
    severity: "Critical",
    location: "Academic Block Lift B",
    nodeId: "Node_14",
  ...
  {
    id: "INC-108",
    description: "Students are waiting because Lift B is not working.",
    category: "Broken Lift",
    severity: "High",
    location: "Academic Block Lift B",
    nodeId: "Node_14",
